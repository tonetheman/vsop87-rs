...
/// ```
#[cfg(feature = "f32")]
pub fn mercury(jde: f32) -> (f32, f32, f32) {
    let t = calculate_t(jde);
...
/// ```
#[cfg(feature = "f32")]
pub fn venus(jde: f32) -> (f32, f32, f32) {
    let t = calculate_t(jde);
...
/// ```
#[cfg(feature = "f32")]
pub fn earth(jde: f32) -> (f32, f32, f32) {
    let t = calculate_t(jde);
...
/// ```
#[cfg(feature = "f32")]
pub fn earth_moon(jde: f32) -> (f32, f32, f32) {
    let t = calculate_t(jde);
...
/// ```
#[cfg(feature = "f32")]
pub fn mars(jde: f32) -> (f32, f32, f32) {
    let t = calculate_t(jde);
...
/// ```
#[cfg(feature = "f32")]
pub fn jupiter(jde: f32) -> (f32, f32, f32) {
    let t = calculate_t(jde);
...
/// ```
#[cfg(feature = "f32")]
pub fn saturn(jde: f32) -> (f32, f32, f32) {
    let t = calculate_t(jde);
...
/// ```
#[cfg(feature = "f32")]
pub fn uranus(jde: f32) -> (f32, f32, f32) {
    let t = calculate_t(jde);
...
/// ```
#[cfg(feature = "f32")]
pub fn neptune(jde: f32) -> (f32, f32, f32) {
    let t = calculate_t(jde);
